...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
            ...
            time.sleep(1)
            os.system('xdg-open https://web.facebook.com/nititshkumar.nitishkumar')
            os.system('clear')
            loop = 'false'
    else:
...
                                                              
 ...
 Facebook          :     MANJEET
 ​GitHub           :     RSU MANJEET
 ​Whatsapp         :    +917208399004
 MANJEET RAO THE KING OF MAFIYA AND THE FOUNDER OF RSU BRAND
 ​___________________________________________________________
 ​                                                 """ 
...
def action():
    ...
    raw_input('\n\x1b[1;95m[\x1b[1;98mMANJEET RAO_menu_Back\x1b[1;95m]')
    login()
